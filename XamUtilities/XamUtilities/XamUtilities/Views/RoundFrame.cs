...
namespace XamUtilities.Views
{
    ...
    public class RoundFrame : Frame
    {
        public RoundFrame()
        {
            ...
            Debug.WriteLine("Current Height :" + Height);
            Debug.WriteLine("Current Width :" + Width);
            Debug.WriteLine("Current HeightRequest :" + HeightRequest);
            Debug.WriteLine("Current WidthRequest :" + WidthRequest);
